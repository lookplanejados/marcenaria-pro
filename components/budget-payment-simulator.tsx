...
export function BudgetPaymentSimulator({ budget, onChange, readOnly = false }: Props) {
    ...
    return (
        <div className="space-y-3">
            {showPrazo && (
                <div className="rounded-xl border border-indigo-100 bg-indigo-50 dark:bg-indigo-900/10 dark:border-indigo-900/30 p-4 space-y-3">
            ...
            {showAvista && (
                <div className="rounded-xl border border-emerald-100 bg-emerald-50 dark:bg-emerald-900/10 dark:border-emerald-900/30 p-4 space-y-3">
                    <div className="flex items-center gap-2">
